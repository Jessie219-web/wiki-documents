...
**ステップ 1**: 3 つのサイトを作成します。Equip Tree でサイトを作成する方法については、この [wiki](https://wiki.seeedstudio.com/reComputer_r1000_fin_modbus_tcp_and_rtu/#add-data-points-to-equip-tree) を参照してください。そして、システムコンテキストをホームディレクトリに保持してください。
