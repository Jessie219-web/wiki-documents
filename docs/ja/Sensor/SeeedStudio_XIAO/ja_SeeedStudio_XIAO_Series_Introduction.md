...
<font size={"2"}>
   ...
   <tr>
	    <td colspan="11"><div class="get_one_now_container" style={{textAlign: 'center'}}><a class="get_one_now_item" href="https://wiki.seeedstudio.com/xiao_topic_page/"><strong><span><font color={'FFFFFF'} size={"3"}>📚 互換プロジェクト</font></span></strong></a></div></td>        
	</tr>
    <tr>
	    <th>Arduino</th>
	    <td align="center"><font size={"3"}>✅</font></td>
...
<font size={"2"}>
    ...
    <tr>
        ...
        <td><div class="get_one_now_container" style={{textAlign: 'center'}}><a class="get_one_now_item" href="https://wiki.seeedstudio.com/XIAO-Kit-Courses/"><strong><span><font color={'FFFFFF'} size={"4"}>📚 コース</font></span></strong></a></div></td> 
