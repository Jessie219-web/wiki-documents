...
<p style={{textAlign: 'center'}}><img src="/img/board_select.png" alt="pir" width={800} height="auto" /></p>

Then open an example of your choice (in this case the accelerator example):

<p style={{textAlign: 'center'}}><img src="/img/example_select.png" alt="pir" width={800} height="auto" /></p>
...
<p style={{textAlign: 'center'}}><img src="/img/example_compile.png" alt="pir" width={800} height="auto" /></p>
...
<p style={{textAlign: 'center'}}><img src="/img/export_binary.png" alt="pir" width={800} height="auto" /></p>
...
<p style={{textAlign: 'center'}}><img src="/img/usb_cdc.png" alt="pir" width={800} height="auto" /></p>

Then open the serial monitor using `Tools -> Serial Monitor` and start observing the messages:
<p style={{textAlign: 'center'}}><img src="/img/serial_monitor.png" alt="pir" width={800} height="auto" /></p>
...
<p style={{textAlign: 'center'}}><img src="/img/lorawan_credentials.png" alt="pir" width={800} height="auto" /></p>

If your region has duty cycle restrictions, make sure to enable the limitation in the reset handler:
<p style={{textAlign: 'center'}}><img src="/img/duty_cycle_limitation.png" alt="pir" width={800} height="auto" /></p>
...
<p style={{textAlign: 'center'}}><img src="/img/ttn_live_data.png" alt="pir" width={800} height="auto" /></p>
