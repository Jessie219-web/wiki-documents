...
XIAO ESP32S3 に事前に Meshtastic ファームウェアがフラッシュされていることを確認してください。まだフラッシュしていない場合は、[この手順](https://wiki.seeedstudio.com/wio_sx1262_xiao_esp32s3_for_meshtastic/#flash-firmware)に従ってフラッシュしてください。
