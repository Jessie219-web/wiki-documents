...
* [SDK のインストールとセットアップ](https://wiki.seeedstudio.com/wio_tracker_dual_stack#setup-toolchain)
* [ファームウェアのフラッシング](https://wiki.seeedstudio.com/wio_tracker_dual_stack#build-and-flash-the-demo)
* AWS IoT Core の設定
* Amazon Location の設定
