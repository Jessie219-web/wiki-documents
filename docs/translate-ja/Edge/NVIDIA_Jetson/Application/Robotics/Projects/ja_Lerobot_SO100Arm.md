...
- [Lerobotのインストール](https://wiki.seeedstudio.com/lerobot_so100m/#install-lerobot)を実行した後、GPUバージョンのpytorchが自動的にアンインストールされる可能性があるため、torch-gpuを手動でインストールする必要があります。
