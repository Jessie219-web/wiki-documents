---
id: sensecap-mx-dashboard
title: SenseCAP MX Dashboard – Web3 DePIN Device & dApp Management
description: Learn how to manage your SenseCAP MX devices and deploy decentralized applications (dApps) using the SenseCAP MX Dashboard, powered by SenseCraft Fleet Management infrastructure.
slug: /cloud-chain/sensecap-mx/dashboard
keywords:
  - SenseCAP MX
  - Web3 Device Management
  - DePIN
  - dApp Deployment
  - Fleet Management
  - SenseCraft
  ...
  - FluxNode
  - Mysterium Node
image: https://files.seeedstudio.com/wiki/wiki-platform/sensecap-mx-dashboard.png
last_update:
  date: 2025-06-05
  author: Jancee
hide_title: false
